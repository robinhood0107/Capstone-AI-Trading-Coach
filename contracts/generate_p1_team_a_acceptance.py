...
def operations(openapi: Mapping[str, Any]) -> dict[tuple[str, str], dict[str, Any]]:
    ...
    if len(result) != 56 or len(ids) != 56:
        raise ContractError("root OpenAPI must contain exact 56 unique operations")
    return result
...
def generate_client(openapi: Mapping[str, Any]) -> bytes:
    root_operations = operations(openapi)
    paths = object_value(openapi.get("paths"), "paths")
    ...
    source = f"""// Generated by contracts/generate_p1_team_a_acceptance.py. Do not edit.
