...
from contracts.generate_s6_contracts import (  # noqa: E402
...
from contracts.generate_s7_s8_contracts import (  # noqa: E402
...
def validate_example_semantics(
    ...
    if schema_name in S4_5_PROVIDER_PACKET_SCHEMAS:
        ...
        return
    if schema_name in S6_SCHEMA_IDS:
    ...
    if schema_name in S6_RETIREMENT_SCHEMA_IDS:
        ...
        return
    if schema_name in S7_S8_SCHEMA_IDS:
        if not isinstance(example, dict):
