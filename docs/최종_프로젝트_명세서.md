...
>
> 선행 계약 동결(2026-07-22): S1.6 prerequisite PR은 Testcontainers와 S1.4X reference
> amendment 및 아래 내부 계약만 고정한다. production collector/migration과 public API는 후속
> PR 범위이며, provider 호출·merge·online 활성화를 승인하지 않는다.
