...
BEGIN
    IF to_regprocedure(
        ...
        -- LightGBM은 연구 전용이다. 기존 volume 재적용도 V74가 회수한 production capability를
        -- 되살리지 않고 public reader의 clock capability만 보존한다.
        REVOKE ALL PRIVILEGES ON FUNCTION
        ...
        FROM decision_signal_scheduler, decision_signal_admin;
        REVOKE ALL PRIVILEGES ON FUNCTION
