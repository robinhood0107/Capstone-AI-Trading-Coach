...
class KISMockFailureReason(StrEnum):
    ...
    EXECUTION_FILL_DETECTED = "EXECUTION_FILL_DETECTED"
    EXECUTION_RECONCILIATION_FAILED = "EXECUTION_RECONCILIATION_FAILED"
    BALANCE_RECONCILIATION_CHANGED = "BALANCE_RECONCILIATION_CHANGED"
    OPEN_ORDER_RECONCILIATION_FAILED = "OPEN_ORDER_RECONCILIATION_FAILED"
