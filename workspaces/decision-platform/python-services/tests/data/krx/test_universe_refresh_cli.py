...
@pytest.mark.parametrize(
    ...
    [
        ...
        (KrxCredentialError("connect_timeout"), 1, "connect_timeout"),
        (KrxCredentialError("read_timeout"), 1, "read_timeout"),
        (KrxCredentialError("write_timeout"), 1, "write_timeout"),
        (KrxCredentialError("pool_timeout"), 1, "pool_timeout"),
        (KrxCredentialError("connect_unavailable"), 1, "connect_unavailable"),
        (KrxCredentialError("read_unavailable"), 1, "read_unavailable"),
        (KrxCredentialError("write_unavailable"), 1, "write_unavailable"),
        (KrxCredentialError("protocol_unavailable"), 1, "protocol_unavailable"),
