...
s1_4x_assert_benchmark_python_closure >/dev/null
...
exec /usr/bin/env -i -a "$BENCHMARK_PYTHON" \
  ...
  S1_4X_BENCHMARK_PYTHON_INITIAL_ROUTE_IDENTITY="$S1_4X_BENCHMARK_PYTHON_INITIAL_ROUTE_IDENTITY" \
  S1_4X_BENCHMARK_PYTHON_INITIAL_VENV_IDENTITY="$S1_4X_BENCHMARK_PYTHON_INITIAL_VENV_IDENTITY" \
  S1_4X_BENCHMARK_PYTHON_INITIAL_VENV_SHA256="$S1_4X_BENCHMARK_PYTHON_INITIAL_VENV_SHA256" \
  S1_4X_BENCHMARK_PYTHON_INITIAL_DEPENDENCIES="$S1_4X_BENCHMARK_PYTHON_INITIAL_DEPENDENCIES" \
