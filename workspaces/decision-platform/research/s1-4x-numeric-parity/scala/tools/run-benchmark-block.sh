...
JAVAC_EXECUTABLE="$JAVA_RUNTIME_HOME/bin/javac"
...
JAVAC_EXECUTABLE_SHA256="5dc287a983c41c8cee0c00e621d87a46ff9dd77202885814b39645074d714dd9"
...
verify_executable \
  "javac executable" "$JAVAC_EXECUTABLE" "$JAVAC_EXECUTABLE_SHA256"
...
exec /usr/bin/env -i \
  ...
  S1_4X_SCALA_JAVAC_BIN="$JAVAC_EXECUTABLE" \
  S1_4X_SCALA_JAVAC_SHA256="$JAVAC_EXECUTABLE_SHA256" \
