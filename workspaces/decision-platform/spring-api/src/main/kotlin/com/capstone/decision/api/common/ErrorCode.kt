...
enum class ErrorCode(
    ...
    IDEMPOTENCY_RESULT_UNAVAILABLE(HttpStatus.CONFLICT, "The idempotent result is no longer available."),
    ...
    RAG_HISTORY_PERSIST_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "RAG answer history could not be persisted."),
    RAG_HISTORY_CORRUPTED(HttpStatus.SERVICE_UNAVAILABLE, "RAG answer history is unavailable."),
    ...
    SIGNAL_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "Signal evidence storage is unavailable."),
