...
internal class PreS5VertexActivationReader(
    ...
    private fun parsePacket(raw: ByteArray): PreS5VertexActivation {
        try {
            ...
            require(text(values, "contractId") == "pre-s5-vertex-activation/v1")
            ...
            require(PROJECT_ID.matches(text(values, "projectId")))
            require(text(values, "location") == "global")
    ...
    private companion object {
        ...
        val PACKET_FIELDS =
            setOf(
                ...
                "ciDigest",
                "securityDigest",
                "credentialFileSecurityEvidenceSha256",
                "projectCacheStateEvidenceSha256",
