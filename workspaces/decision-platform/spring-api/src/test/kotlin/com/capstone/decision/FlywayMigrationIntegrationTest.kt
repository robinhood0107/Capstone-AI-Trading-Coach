...
class FlywayMigrationIntegrationTest(
    ...
    @Test
    fun `clean database applies V1 through V105 migrations and creates required objects`() {
        ...
        assertEquals((1..105).map(Int::toString), versions)
    ...
    companion object {
        ...
        fun postgresProperties(registry: DynamicPropertyRegistry) {
            ...
            registry.add("spring.flyway.target") { "105" }
