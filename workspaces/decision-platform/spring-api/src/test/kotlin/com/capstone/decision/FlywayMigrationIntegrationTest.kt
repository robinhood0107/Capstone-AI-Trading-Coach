...
class FlywayMigrationIntegrationTest(
    ...
    @Test
    fun `clean database applies V1 through V95 migrations and creates required objects`() {
        ...
        assertEquals((1..95).map(Int::toString), versions)
    ...
    companion object {
        ...
        fun postgresProperties(registry: DynamicPropertyRegistry) {
            ...
            registry.add("spring.flyway.target") { "95" }
