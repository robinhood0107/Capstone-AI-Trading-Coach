...
class FlywayMigrationIntegrationTest(
    ...
    @Test
    fun `clean database applies V1 through V99 migrations and creates required objects`() {
        ...
        assertEquals((1..99).map(Int::toString), versions)
    ...
    companion object {
        ...
        fun postgresProperties(registry: DynamicPropertyRegistry) {
            ...
            registry.add("spring.flyway.target") { "99" }
