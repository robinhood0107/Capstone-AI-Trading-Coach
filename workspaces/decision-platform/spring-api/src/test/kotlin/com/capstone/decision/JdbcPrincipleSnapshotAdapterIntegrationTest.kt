    ...
    fun `S2_3 production context exposes only stored observation or typed unavailable source adapters`() {
        val expectedBeans =
            mapOf(
                ...
                OrderMetricPort::class.java to setOf("decisionOrderMetricPort"),
                RiskSnapshotPort::class.java to setOf("decisionRiskSnapshotPort"),
                InstrumentCatalogPort::class.java to setOf("decisionInstrumentCatalogPort"),
