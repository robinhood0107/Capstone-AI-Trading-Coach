...
// JDK 25에서 MockK bytecode agent가 최소 mock 생성까지 가능한지 PR gate로 확인한다.
class MockKJdk25SmokeTest {
    // 향후 의존성 업그레이드가 mock 생성 자체를 깨뜨리면 빠르게 분리 대응하기 위함이다.
    @Test
    ...
    // 외부 의존성 없는 작은 interface가 MockK/JDK 호환성만 순수하게 드러낸다.
