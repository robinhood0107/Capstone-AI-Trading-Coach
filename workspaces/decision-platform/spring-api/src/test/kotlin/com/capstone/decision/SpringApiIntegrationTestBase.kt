...
// 왜: 테스트 secret/password를 코드 리터럴로 박지 않고 동적 property로 주입해 secret scan 잡음을 줄인다.
abstract class SpringApiIntegrationTestBase {
    protected fun userPassword(): String = userPasswordValue

    companion object {
        // 왜: HS256 최소 길이와 demo 로그인 계약을 만족하는 더미 값을 테스트 런타임에만 만든다.
        ...
        // 왜: 모든 SpringBootTest가 같은 demo 인증 설정을 공유해야 토큰 기반 helper가 안정적이다.
